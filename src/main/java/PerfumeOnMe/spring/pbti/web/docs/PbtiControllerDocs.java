package PerfumeOnMe.spring.pbti.web.docs;
...
public interface PbtiControllerDocs {
	...
	ResponseEntity<ApiResponse<PbtiResponseDTO.PbtiQuestionResponse>> searchPbti(
	...
	ResponseEntity<ApiResponse<PbtiResponseDTO.PbtiSaveResponse>> savePbti(
	...
	ResponseEntity<ApiResponse<PbtiResponseDTO.SearchPbtiListResponse>> searchPbtiList(
		@AuthenticationPrincipal CustomUserDetails userDetails);
	...
	ResponseEntity<ApiResponse<PbtiResponseDTO.UpdatePbtiNameResponse>> updatePbtiName(
	...
	ResponseEntity<ApiResponse<Void>> deletePbtiResult(
		@PathVariable Long pbtiId,
		@AuthenticationPrincipal CustomUserDetails userDetails);
}