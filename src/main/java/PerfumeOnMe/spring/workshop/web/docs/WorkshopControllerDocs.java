package PerfumeOnMe.spring.workshop.web.docs;
...
public interface WorkshopControllerDocs {
	...
	ResponseEntity<ApiResponse<WorkshopResponseDTO.WorkshopPreviewResponseDTO>> getWorkshopPreview(
	...
	ResponseEntity<ApiResponse<WorkshopResponseDTO.WorkshopSaveResponseDTO>> saveWorkshopResult(
	...
	ResponseEntity<ApiResponse<List<WorkshopResponseDTO.WorkshopListResponseDTO>>> getWorkshopList(
		@Parameter(hidden = true)
		@AuthenticationPrincipal CustomUserDetails userDetails
	);
	...
	ResponseEntity<ApiResponse<WorkshopResponseDTO.WorkshopDetailResponseDTO>> getWorkshopDetail(
