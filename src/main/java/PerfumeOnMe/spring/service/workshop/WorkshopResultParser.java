...
public class WorkshopResultParser {
	 ...
	 * 향기로 해석한 당신의 성향: 복합적이고 다층적인 매력을 가진 당신은 첫인상은 밝고 활기차지만, 깊이 알수록 더욱 매력적인 면을 발견하게 됩니다. 당신은 사람들에게 '기분 좋은 여운이 오래 남는 사람'으로 기억됩니다.
	 */
	public WorkshopResult parseGptResponse(String gptResponse) {
		try {
			...
			return WorkshopResult.builder()
				...
				.tendency("개성 있는 향을 추구하는 당신은 자신만의 스타일을 가진 사람입니다. 당신은 사람들에게 '특별한 매력을 가진 사람'으로 기억됩니다.")
				.build();
		}
	}
